...
import { ChevronRight, Heart, Sun, GraduationCap, Users, ArrowRight, Leaf, Handshake } from "lucide-react";
...
const programs = [
  {
    ...
    highlights: [
      "Tặng 300+ phần quà Tết (gạo, dầu ăn, mì tôm, tiền mặt)",
  ...
  },
  {
    ...
    desc: "SolarLab là sáng kiến giáo dục của Tona nhằm đưa kiến thức về năng lượng tái tạo đến với học sinh THPT và sinh viên kỹ thuật. Thông qua các buổi workshop thực hành, tham quan dự án solar và cuộc thi thiết kế, Tona góp phần ươm mầm thế hệ kỹ sư xanh cho tương lai.",
    stats: [
...
export function CSR() {
  return (
    <div className="w-full bg-white min-h-screen">
      ...
      <div className="bg-[#002d17] pt-8 pb-20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-2 text-white/40 text-xs font-bold uppercase tracking-widest mb-8 flex-wrap">
            ...
            <ChevronRight size={12} />
            <span className="text-[#f4aa1f]">Trách Nhiệm Cộng Đồng</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            <div>
              ...
              <p className="text-white/60 text-base font-medium leading-relaxed max-w-lg">
                Tona Corporation tin rằng doanh nghiệp phát triển bền vững phải song hành với trách nhiệm xã hội. Mỗi công trình chúng tôi xây dựng không chỉ là kết cấu thép và bê tông — mà còn là cam kết với con người và cộng đồng.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-14">
            ...
            <p className="text-[#002d17]/50 text-sm font-medium mt-3 max-w-xl">
              Ba sáng kiến cốt lõi phản ánh cam kết dài hạn của Tona với cộng đồng — từ chia sẻ ấm áp mỗi dịp Tết đến ươm mầm tri thức cho thế hệ kỹ sư tương lai.
            </p>
          </div>
      ...
      {/* COMMITMENT STRIP */}
      <section className="bg-[#f9f9f7] py-16 border-y border-[#002d17]/10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <div className="w-16 h-1 bg-[#f4aa1f] mb-6" />
              <h3 className="text-2xl md:text-3xl font-extrabold text-[#002d17] uppercase tracking-tight mb-4">
                Cam Kết Lâu Dài<br />Với Cộng Đồng
              </h3>
              <p className="text-[#002d17]/60 text-sm leading-relaxed font-medium max-w-lg">
                Tona dành ít nhất 1% doanh thu hàng năm cho các hoạt động CSR. Các chương trình được điều hành bởi Ủy ban CSR nội bộ gồm đại diện từ mọi phòng ban — đảm bảo tiếng nói và sự tham gia của toàn bộ nhân viên.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            ...
            <h3 className="text-2xl font-extrabold text-white uppercase tracking-tight">
              Cùng Tona Tạo Ra Sự Khác Biệt
            </h3>
            <p className="text-white/50 mt-2 text-sm font-medium">
              Gia nhập Tona — nơi công việc của bạn không chỉ xây nên công trình mà còn xây dựng cộng đồng.
            </p>
          </div>
