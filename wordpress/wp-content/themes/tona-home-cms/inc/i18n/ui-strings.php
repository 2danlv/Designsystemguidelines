...
function tona_cms_ui_string_defaults() {
    return array(
        'common.home'              => 'Home',
        'common.news'              => 'News',
        'common.culture'           => 'Tona Life',
        'common.back'              => 'Back',
        'common.all'               => 'All',
        'common.highlights'        => 'Highlights',
        'common.video_title'       => 'Tona video',
        'common.switch_language'   => 'Switch to',
        'common.menu_toggle'       => 'Toggle menu',
        'home.hero.primary_label' => 'View Projects',
        'home.hero.secondary_label' => 'Services',
        'home.services.title'     => 'Core Services',
        'home.services.strength'  => 'Strength',
        ...
        'home.projects.detail'    => 'Project details',
        ...
        'jobs.form.success'       => 'Your application was submitted successfully.',
        'jobs.form.error'         => 'Your application could not be submitted. Please try again.',
        'jobs.form.submitting'    => 'Submitting...',
        'members.since'           => 'At Tona since',
        'members.education'       => 'Education & Certifications',
        'members.expertise'       => 'Expertise',
        'members.achievements'    => 'Key Achievements',
        ...
        'news.cta_title'          => 'Your Project?',
        'news.cta_description'    => 'Contact Tona today for a consultation.',
        'news.cta_button'         => 'Contact',
        'news.more'               => 'More News',
        'projects.all'            => 'All',
        'projects.detail'         => 'View Details',
        'services.construction_suffix' => 'construction',
        'services.featured_project'    => 'Featured Project',
        'services.project_year'        => 'Year',
        'services.project_detail'      => 'View Details',
        'services.projects_all'        => 'View All Projects',
        'culture.academy_image_alt'    => 'Tona Academy',
        'culture.gallery_image_alt'    => 'Tona Culture',
